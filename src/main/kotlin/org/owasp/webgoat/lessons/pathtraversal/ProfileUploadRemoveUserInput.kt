...
class ProfileUploadRemoveUserInput(
    ...
    fun uploadFileHandler(
        @RequestParam("uploadedFileRemoveUserInput") file: MultipartFile,
        @CurrentUsername username: String,
    ): AttackResult = super.execute(file, file.originalFilename, username)
}
