...
class DeserializeTest : LessonTest() {
    @Test
    fun success() {
        if (OS.indexOf("win") > -1) {
            mockMvc
                    ...
                    MockMvcRequestBuilders
                        ...
                        .param(
                            ...
                            SerializationHelper.toString(
                                VulnerableTaskHolder("wait", "ping localhost -n 5"),
                            ),
                        ),
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    ...
                    .param(
                        "token",
                        SerializationHelper.toString(VulnerableTaskHolder("delete", "rm *")),
                    ),
            ).andExpect(status().isOk)
