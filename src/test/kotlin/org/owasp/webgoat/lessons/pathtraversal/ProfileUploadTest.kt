...
@WithWebGoatUser
class ProfileUploadTest : LessonTest() {
    @BeforeEach
    fun setup() {
        ...
        mockMvc
            .perform(
                MockMvcRequestBuilders
                    .multipart("/PathTraversal/profile-upload")
                    .file(profilePicture)
    ...
    @Test
    @WithWebGoatUser
    fun shouldNotOverrideExistingFile() {
        val profilePicture =
            MockMultipartFile(
                "uploadedFile",
                "picture.jpg",
            ...
            .perform(
                ...
                jsonPath(
                    ...
                    CoreMatchers.anyOf(
                        ...
                        CoreMatchers.containsString("..\\\\test"),
                    ),
                ),
            ).andExpect(status().`is`(200))
    }
